...
<body>
	<div class="row my-3">
		<div class="col-4 offset-4">
			...
			<h1 >New Ninja</h1>
			<form:form action="/new/ninjas" method="post" modelAttribute="ninja">
				<div >
					<form:label path="dojo" for="dojo" class="form-label">Dojo:</form:label>
				...
				<div class="mb-3">
					...
					<div>
						<form:errors class="text-primary" path="firstName" />
					</div>
				...
				<div class="mb-3">
					...
					<div>
						<form:errors class="text-primary" path="lastName" />
					</div>
				...
				<div class="mb-3">
					...
					<div>
						<form:errors class="text-primary" path="age" />
					</div>
